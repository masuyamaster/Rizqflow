...
/**
 * Logo "G" Google empat warna. Warna dan bentuknya tidak boleh diubah (pedoman merek Google);
 * hanya ukuran dan latar tombol yang boleh menyesuaikan tema.
 */
internal val GoogleGLogo: ImageVector = ImageVector.Builder(
    name = "GoogleG",
    defaultWidth = 24.dp,
    defaultHeight = 24.dp,
    viewportWidth = 48f,
    ...
    segments.forEach { (color, data) ->
        addPath(pathData = addPathNodes(data), fill = SolidColor(Color(color)))
    }
}.build()
