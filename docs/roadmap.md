...
**Status 2026-09-23:** paywall, titik penguncian, dan aturan alokasi lanjutan selesai; sisanya (billing sungguhan, sistem per peran, multi-profil haul, harga emas otomatis, laporan/insight/multi-mata uang/widget/tema, uji penguji lisensi) menunggu, sebagian bergantung pada akun developer Play Console (Tahap 8).
